...
/**
 * DTO de entrada para la entidad {@link com.unicine.entity.user.AdministradorTeatro}.
 *
 * Incluido:
 * - Datos personales: cedula, nombre, apellido, correo, password.
 *
 * Excluido:
 * - Teatros e imagen: se gestionan por endpoints especificos.
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class AdministradorTeatroRequest {
