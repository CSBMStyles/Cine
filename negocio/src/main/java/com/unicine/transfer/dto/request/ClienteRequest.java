...
/**
 * DTO de entrada para la entidad {@link com.unicine.entity.user.Cliente}.
 *
 * Incluido:
 * - Datos personales: cedula, nombre, apellido, correo, password.
 * - Datos especificos: estado, fechaNacimiento, telefonos.
 *
 * Excluido:
 * - Compras, cupones, colecciones e imagen: se gestionan por endpoints especificos.
 */
@Getter
@Setter
@NoArgsConstructor
