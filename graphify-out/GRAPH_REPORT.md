...
## Corpus Check
- 181 files · ~328,878 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2178 nodes · 3346 edges · 78 communities detected
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 338 edges (avg confidence: 0.78)
...
Cohesion: 0.04
Nodes (60): DetalleFuncionMapper, DetalleFuncionesDTO, DetalleFuncionesProjection, DetallePeliculaHorarioDTO, Movie State Enumeration, EstadoPeliculaService, EstadoPelicula, FormatoPelicula (+52 more)
...
Cohesion: 0.03
Nodes (12): HistorialEstadoPeliculaServicio, EmailService, HistorialEstadoPeliculaRepo, HistorialEstadoPeliculaServicioImp, EmailService, CuponTest, FuncionTest, HorarioTest (+4 more)
...
Cohesion: 0.03
Nodes (18): Customer Entity, Customer Repository, Collection/Catalog Entity, Collection Repository, Coupon/Discount Entity, Coupon Repository, EmailService, Person Base Entity (+10 more)
...
- **Why does `PeliculaDisposicionServicioImp` connect `Community 5` to `Community 4`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `PeliculaServicioImp` connect `Community 3` to `Community 4`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `AdministradorServicioImp` connect `Community 26` to `Community 11`?**
