...
## Corpus Check
- 337 files · ~1,464,679 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3284 nodes · 5277 edges · 159 communities detected
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 693 edges (avg confidence: 0.79)
...
- `UsuarioPrincipal` --implements--> `UserDetails`  [EXTRACTED]
  negocio/src/main/java/com/unicine/security/UsuarioPrincipal.java →   _Bridges community 3 → community 0_

## Communities (182 total, 125 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (78): Administrador, AdministradorServicioImp, AdministradorTeatro, AdministradorTeatroServicioImp, AuthenticationService, Customer Entity, Customer Repository, ClienteServicioImp (+70 more)
...
Cohesion: 0.03
Nodes (15): SecurityConfig, CiudadControllerTest, CompraControllerTest, FuncionControllerTest, PeliculaControllerTest, SalaControllerTest, UnicineException, ApiError (+7 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (20): AdministradorController, CiudadController, ClienteController, CompraController, ConfiteriaController, CuponClienteController, DistribucionSillaController, FuncionController (+12 more)
...
Cohesion: 0.02
Nodes (15): TeatroControllerTest, GlobalExceptionHandlerTest, Imagenable, CiudadMapperTest, AdministradorTeatroTest, AdministradorTest, CiudadTest, ClienteTest (+7 more)
...
Cohesion: 0.02
Nodes (20): Purchase Detail Data Transfer Object, Spring Data JPA Repository Interface, MedioPago, ConfiteriaRepo, ConfiteriaServicioImp, CompraRepo, AdministradorRepo, AdministradorTeatroRepo (+12 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (11): Collection/Catalog Entity, Collection Repository, ColeccionServicio, ColeccionController, ColeccionControllerTest, ColeccionMapper, ColeccionRepo, ColeccionServicio (+3 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (8): DetalleFuncionMapper, FuncionMapperTest, DetalleFuncionesProjection, PeliculaTest, FuncionServicioImp, FuncionServicioTest, PeliculaServicioTest, FuncionServicioImp

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (11): ConfiteriaPresentacion, HistorialPrecioPresentacionRepo, HistorialPrecioPresentacionServicioImp, ConfiteriaPresentacionServicio, ConfiteriaServicio, ConfiteriaControllerTest, HistorialPrecioControllerTest, PresentacionControllerTest (+3 more)
...
Cohesion: 0.08
Nodes (4): CuponController, CuponControllerTest, CuponServicio, CuponServicioTest
...
Cohesion: 0.11
Nodes (3): CuponClienteControllerTest, CuponClienteServicio, CuponClienteServicioTest
...
Cohesion: 0.19
Nodes (3): ClienteServicio, CompraServicio, ClienteControllerTest
...
- **Why does `CompraConfiteriaServicioImp` connect `Community 29` to `Community 1`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `ImagenServicioImp` connect `Community 4` to `Community 0`, `Community 23`?**
